...
const Steps = () => {
  ...
  <div className="min-h-screen flex justify-center items-center bg-hero bg-fixed bg-no-repeat bg-cover bg-center">
    ...
    <div className="order-2 lg:order-1 flex flex-col justify-center items-center">
      <p className="text-4xl font-bold md:text-7xl text-white">WELCOME TO</p>
      <p className="text-4xl font-bold md:text-7xl text-black">OUR GYM</p>
      <p className="mt-2 text-sm md:text-lg text-black">Seize the opportunity! It's time to get in<br/>the best shape of your life.</p>
